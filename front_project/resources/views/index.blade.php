...
@section('content')
    <!-- Intro Banner  -->
    <div class="intro-banner" data-background-image="{{asset('assets/images/home-background-01.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="utf-centered-button margin-top-10">
                        <a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-20">View All Categories <i class="icon-feather-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="utf-listings-container-part compact-list-layout margin-top-35">
                        <a href="#" class="utf-job-listing utf-apply-button-item">
                            <div class="utf-job-listing-details">
                                <div class="utf-job-listing-company-logo"> <img src="{{asset('assets/images/company_logo_1.png')}}" alt=""> </div>
                        ...
                        <a href="#" class="utf-job-listing utf-apply-button-item">
                            <div class="utf-job-listing-details">
                                <div class="utf-job-listing-company-logo"> <img src="{{asset('assets/images/company_logo_2.png')}}" alt=""> </div>
                                <div class="utf-job-listing-description">
                                    <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                        ...
                        <a href="#" class="utf-job-listing utf-apply-button-item">
                            <div class="utf-job-listing-details">
                                <div class="utf-job-listing-company-logo"> <img src="{{asset('assets/images/company_logo_3.png')}}" alt=""> </div>
                                <div class="utf-job-listing-description">
                        ...
                        <a href="#" class="utf-job-listing utf-apply-button-item">
                            <div class="utf-job-listing-details">
                                <div class="utf-job-listing-company-logo"> <img src="{{asset('assets/images/company_logo_4.png')}}" alt=""> </div>
                                <div class="utf-job-listing-description">
                                    <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                        ...
                        <a href="#" class="utf-job-listing utf-apply-button-item">
                            <div class="utf-job-listing-details">
                                <div class="utf-job-listing-company-logo"> <img src="{{asset('assets/images/company_logo_5.png')}}" alt=""> </div>
                                <div class="utf-job-listing-description">
                                    <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                        ...
                        <a href="#" class="utf-job-listing utf-apply-button-item">
                            <div class="utf-job-listing-details">
                                <div class="utf-job-listing-company-logo"> <img src="{{asset('assets/images/company_logo_6.png')}}" alt=""> </div>
                                <div class="utf-job-listing-description">
                                    <span class="dashboard-status-button utf-job-status-item green"><i class="icon-material-outline-business-center"></i> Full Time</span>
                    ...
                    <div class="utf-centered-button margin-top-10">
                        <a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-20">Browse All Jobs <i class="icon-feather-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="download-img">
                            <img src="{{asset('assets/images/mockup3.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="utf-testimonial-carousel-block testimonials">
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        <div class="utf-testimonial-avatar-photo"> <img src="{{asset('assets/images/user_small_1.jpg')}}" alt=""> </div>
                ...
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        <div class="utf-testimonial-avatar-photo"> <img src="{{asset('assets/images/user_small_2.jpg')}}" alt=""> </div>
                        <div class="utf-testimonial-author-utf-detail-item">
                            <h4>John Williams</h4>
                ...
                <div class="utf-carousel-review-item">
                    <div class="utf-testimonial-box">
                        <div class="utf-testimonial-avatar-photo"> <img src="{{asset('assets/images/user_small_3.jpg')}}" alt=""> </div>
                        <div class="utf-testimonial-author-utf-detail-item">
                            <h4>John Williams</h4>
                ...
                <div class="col-xl-6 col-md-6 col-xs-12 callout-bg-1 callout-section-left pos-relative">
                    ...
                    <div class="jbm-callout-in jbm-callout-in-padding pull-right">
                        <div class="jbm-section-title margin-top-80 margin-bottom-80">
                            ...
                            <a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-10">Browse Companies <i class="icon-feather-chevrons-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6 col-xs-12 callout-bg-2 callout-section-right pos-relative">
                    ...
                    <div class="jbm-callout-in jbm-callout-in-padding pull-left">
                        <div class="jbm-section-title margin-bottom-80 margin-top-80">
                            ...
                            <span class="section-tit-line"></span>
                            <p>Lorem Ipsum is simply dummy text of printing and type setting industry. Lorem Ipsum been industry standard dummy text ever since, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                            <a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-10">Browse Jobs <i class="icon-feather-chevrons-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row need-help-area justify-content-center">
                ...
                <div class="col-xl-4">
                    <div class="info-box-1">
                        ...
                        <a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-10">Contact Us <i class="icon-feather-chevrons-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="info-box-1">
                        ...
                        <a href="#" class="button utf-ripple-effect-dark utf-button-sliding-icon margin-top-10">Read Blog Post <i class="icon-feather-chevrons-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
